...
class LoadDialog(Settings_ui.Ui_Settings):
    ...
    def __init__(self):
        ...
        # Set limits for icon controls
        Offset_1 = 20
        Offset_2 = Parameters_Ribbon.APP_ICON_SIZE
        Par = Parameters_Ribbon.TABBAR_STYLE
        if Parameters_Ribbon.QUICK_ICON_SIZE > Parameters_Ribbon.TABBAR_STYLE:
            Par = Parameters_Ribbon.TABBAR_STYLE
        if Parameters_Ribbon.APP_ICON_SIZE < Par:
            Offset_2 = Par
        self.form.IconSize_Small.setMaximum((self.RibbonHeight - Offset_1 - Offset_2) / 3)
        self.form.IconSize_Medium.setMaximum((self.RibbonHeight - Offset_1 - Offset_2) / 2)
        self.form.IconSize_Large.setMaximum(self.RibbonHeight - Offset_1 - Offset_2)
