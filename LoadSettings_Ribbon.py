...
class LoadDialog(Settings_ui.Ui_Settings):
    ...
    OriginalValues = {
        "BackupEnabled": Parameters_Ribbon.Settings.GetBoolSetting("BackupEnabled"),
        "BackupFolder": Parameters_Ribbon.Settings.GetStringSetting("BackupFolder"),
        "TabBar_Style": Parameters_Ribbon.Settings.GetIntSetting("TabBar_Style"),
        "IconSize_Small": Parameters_Ribbon.Settings.GetIntSetting("IconSize_Small"),
        "IconSize_Medium": Parameters_Ribbon.Settings.GetIntSetting("IconSize_Medium"),
        "IconSize_Large": Parameters_Ribbon.Settings.GetIntSetting("IconSize_Large"),
        "Stylesheet": Parameters_Ribbon.Settings.GetStringSetting("Stylesheet"),
        "ApplicationButtonSize": Parameters_Ribbon.Settings.GetIntSetting("ApplicationButtonSize"),
        "QuickAccessButtonSize": Parameters_Ribbon.Settings.GetIntSetting("QuickAccessButtonSize"),
        "TabBarSize": Parameters_Ribbon.Settings.GetIntSetting("TabBarSize"),
        "RightToolbarButtonSize": Parameters_Ribbon.Settings.GetIntSetting("RightToolbarButtonSize"),
        "ShowIconText_Small": Parameters_Ribbon.Settings.GetBoolSetting("ShowIconText_Small"),
        "ShowIconText_Medium": Parameters_Ribbon.Settings.GetBoolSetting("ShowIconText_Medium"),
        "ShowIconText_Large": Parameters_Ribbon.Settings.GetBoolSetting("ShowIconText_Large"),
        "MaxColumnsPerPanel": Parameters_Ribbon.Settings.GetIntSetting("MaxColumnsPerPanel"),
        "DebugMode": Parameters_Ribbon.Settings.GetBoolSetting("DebugMode"),
        "ShowOnHover": Parameters_Ribbon.Settings.GetBoolSetting("ShowOnHover"),
        "TabBar_Scroll": Parameters_Ribbon.Settings.GetIntSetting("TabBar_Scroll"),
        "Ribbon_Scroll": Parameters_Ribbon.Settings.GetIntSetting("Ribbon_Scroll"),
        "TabBar_Click": Parameters_Ribbon.Settings.GetIntSetting("TabBar_Click"),
        "Ribbon_Click": Parameters_Ribbon.Settings.GetIntSetting("Ribbon_Click"),
        "Preferred_view": Parameters_Ribbon.Settings.GetIntSetting("Preferred_view"),
