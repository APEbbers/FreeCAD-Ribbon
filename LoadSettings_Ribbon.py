    ...
    def on_tableCell_clicked(self, Item):
        ...
        if row == 0:
            ...
            for i1 in range(1, self.form.tableWidget.rowCount()):
                for i2 in range(1, self.form.tableWidget.columnCount()):
                    if CheckState == Qt.CheckState.Checked:
                        if i2 == column:
                            self.form.tableWidget.item(i1, i2).setCheckState(Qt.CheckState.Checked)
                        else:
                            self.form.tableWidget.item(i1, i2).setCheckState(Qt.CheckState.Unchecked)
