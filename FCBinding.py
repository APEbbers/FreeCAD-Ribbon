...
import pyqtribbon_local_local_local as pyqtribbon_local_local
...
from DragItems import (
    DragSeparator as RibbonSeparator,
    DragPanel as RibbonPanel,
    DragTargetIndicator,
)
...
class ModernMenu(RibbonBar):
    ...
    def __init__(self):
        ...
        if self.ReproAdress != "" or self.ReproAdress is None:
            ...
            for i in range(len(allButtons)):
                ...
                # If the command is already there, remove it, skipp it and increase the counter.
                    ...
                    if button.text().__contains__("separator") and i < len(allButtons):
                        ...
                        # there is a bug in pyqtribbon_local_local_local_local_local where the separator is placed in the wrong position
