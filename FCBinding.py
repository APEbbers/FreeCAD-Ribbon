...
class ModernMenu(RibbonBar):
    ...
    def enterEvent(self, QEvent):
        ...
        if (
            ...
            TB.setMaximumHeight(TB.setFixedHeight(self.ReturnRibbonHeight(self.PanelOffset + self.DynamicFactor)))
    ...
    def ApplicationMenu(self):
        ...
        # Add the overlay menu when the native overlay function is not used
    ...
    def onPinClicked(self):
        ...
        if Parameters_Ribbon.AUTOHIDE_RIBBON is True:
            ...
            TB: QDockWidget = mw.findChildren(QDockWidget, "Ribbon")[0]
            # TB.setFixedHeight(self.ReturnRibbonHeight(self.PanelOffset + 20))
            TB.setFixedHeight(self.ReturnRibbonHeight(self.PanelOffset + self.DynamicFactor))
    ...
    def buildPanels(self):
                    ...
                    if "separator" in button.text() and i < len(allButtons):
                        ...
                        try:
                            ...
                            if buttonSize == "small":
                                ...
                                panel.addSmallWidget(btn, alignment=Qt.AlignmentFlag.AlignLeft, fixedHeight=True)
                                ...
                                # add the button as large button
                                panel.addMediumWidget(btn, alignment=Qt.AlignmentFlag.AlignLeft, fixedHeight=True)
        ...
        self.setRibbonHeight(self.ReturnRibbonHeight(self.PanelOffset) + self.DynamicFactor)
        return
