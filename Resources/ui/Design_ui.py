...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMaximumSize(QSize(940, 724))
        ...
        sizePolicy2.setHeightForWidth(self.ToolbarName.sizePolicy().hasHeightForWidth())
        self.ToolbarName.setSizePolicy(sizePolicy2)
