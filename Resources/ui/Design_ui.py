...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.MoveUp_Command_QC.setText("...")
        ...
        self.Remove_Command_QC.setText("...")
        ...
        self.RemoveWorkbench_IW.setText("...")
        ...
        self.MoveUpCommand_DDB.setText("...")
        ...
        self.RemoveCommand_DDB.setText("...")
        ...
        self.AddPanelCommand_NP.setText("...")
    ...
    def retranslateUi(self, Form):
        ...
        self.TimeStamp_Reloaded.setText(
            QCoreApplication.translate("Form", "Last reloaded on: -", None)
        )
        self.LoadWB.setText("")
