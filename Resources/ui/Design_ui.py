...
################################################################################
## Form generated from reading UI file 'DesignOrhUhr.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_53 = QGridLayout(Form)
        ...
        self.UpdateJson.setObjectName(u"UpdateJson")

        self.gridLayout_6.addWidget(self.UpdateJson, 3, 4, 1, 1)

        self.Close = QPushButton(Form)
        self.Close.setObjectName(u"Close")

        self.gridLayout_6.addWidget(self.Close, 3, 5, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1187, 621))
        ...
        self.InItialSetup.setObjectName(u"InItialSetup")
        ...
        self.DefaultButtonSize_IS_Workbenches.addItem("")
        self.DefaultButtonSize_IS_Workbenches.addItem("")
        self.DefaultButtonSize_IS_Workbenches.setObjectName(u"DefaultButtonSize_IS_Workbenches")
        ...
        self.GenerateSetup_IS_WorkBenches.setObjectName(u"GenerateSetup_IS_WorkBenches")
        ...
        self.DefaultButtonSize_IS_Panels.addItem("")
        self.DefaultButtonSize_IS_Panels.addItem("")
        self.DefaultButtonSize_IS_Panels.setObjectName(u"DefaultButtonSize_IS_Panels")
        ...
        self.GenerateSetup_IS_Panels.setObjectName(u"GenerateSetup_IS_Panels")
        ...
        self.ImportWorkbenchSelector_IS.setObjectName(u"ImportWorkbenchSelector_IS")

        self.gridLayout_24.addWidget(self.ImportWorkbenchSelector_IS, 0, 0, 1, 1)

        self.ImportWorkbench_IS = QPushButton(self.groupBox_3)
        self.ImportWorkbench_IS.setObjectName(u"ImportWorkbench_IS")
        ...
        self.CustomPanelPositionLeft.setObjectName(u"CustomPanelPositionLeft")
        ...
        self.CustomPanelPositionRight.setObjectName(u"CustomPanelPositionRight")
        ...
        self.gridLayout_52 = QGridLayout(self.QAToolbars)
        ...
        self.MoveUp_Command_QC.setObjectName(u"MoveUp_Command_QC")
        self.MoveUp_Command_QC.setText(u"...")
        ...
        self.MoveDown_Command_QC.setObjectName(u"MoveDown_Command_QC")
        self.MoveDown_Command_QC.setText(u"...")
        ...
        self.Remove_Command_QC.setObjectName(u"Remove_Command_QC")
        self.Remove_Command_QC.setText(u"...")
        ...
        self.Add_Command_QC.setObjectName(u"Add_Command_QC")
        self.Add_Command_QC.setText(u"...")
        ...
        self.ListCategory_QC.setObjectName(u"ListCategory_QC")
        ...
        self.SearchBar_QC.setObjectName(u"SearchBar_QC")
        ...
        self.RemoveSeparator_QC = QPushButton(self.frame)
        self.RemoveSeparator_QC.setObjectName(u"RemoveSeparator_QC")
        self.RemoveSeparator_QC.setMinimumSize(QSize(100, 0))
        font1 = QFont()
        font1.setBold(False)
        font1.setStyleStrategy(QFont.NoAntialias)
        self.RemoveSeparator_QC.setFont(font1)

        self.gridLayout_7.addWidget(self.RemoveSeparator_QC, 0, 2, 1, 1)

        self.AddSeparator_QC = QPushButton(self.frame)
        self.AddSeparator_QC.setObjectName(u"AddSeparator_QC")
        self.AddSeparator_QC.setMinimumSize(QSize(100, 0))
        self.AddSeparator_QC.setFont(font1)

        self.gridLayout_7.addWidget(self.AddSeparator_QC, 0, 1, 1, 1)
        ...
        self.RemovePanel_EP.setObjectName(u"RemovePanel_EP")
        ...
        self.AddPanel_EP.setObjectName(u"AddPanel_EP")
        ...
        self.ListCategory_EP.setObjectName(u"ListCategory_EP")
        ...
        self.SearchBar_EP.setObjectName(u"SearchBar_EP")
        ...
        self.RemoveWorkbench_IW.setObjectName(u"RemoveWorkbench_IW")
        self.RemoveWorkbench_IW.setText(u"...")
        ...
        self.AddWorkbench_IW.setObjectName(u"AddWorkbench_IW")
        self.AddWorkbench_IW.setText(u"...")
        ...
        sizePolicy5.setHeightForWidth(self.CustomToolbarSelector_CP.sizePolicy().hasHeightForWidth())
        self.CustomToolbarSelector_CP.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.PanelName_CP.sizePolicy().hasHeightForWidth())
        self.PanelName_CP.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.WorkbenchList_CP.sizePolicy().hasHeightForWidth())
        self.WorkbenchList_CP.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.RemovePanel_CP.sizePolicy().hasHeightForWidth())
        self.RemovePanel_CP.setSizePolicy(sizePolicy6)
        ...
        self.groupBox_31 = QGroupBox(self.CombineToolbars)
        self.groupBox_31.setObjectName(u"groupBox_31")
        self.groupBox_31.setSizeIncrement(QSize(0, 0))
        ...
        self.label_11 = QLabel(self.groupBox_31)
        ...
        self.AddCustomPanel_CP = QPushButton(self.groupBox_31)
        ...
        sizePolicy7.setHeightForWidth(self.AddCustomPanel_CP.sizePolicy().hasHeightForWidth())
        ...
        self.MoveUpPanelCommand_CP = QToolButton(self.groupBox_31)
        ...
        self.AddPanel_CP = QToolButton(self.groupBox_31)
        ...
        self.MoveDownPanelCommand_CP = QToolButton(self.groupBox_31)
        ...
        self.gridLayout_21.addWidget(self.groupBox_31, 1, 0, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.NewControl_DDB.sizePolicy().hasHeightForWidth())
        self.NewControl_DDB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.RemoveControl_DDB.sizePolicy().hasHeightForWidth())
        self.RemoveControl_DDB.setSizePolicy(sizePolicy6)
        ...
        self.gridLayout_43.addWidget(self.groupBox_5, 1, 3, 1, 1)

        self.tabWidget.addTab(self.tab, "")
        self.Createnewpanels = QWidget()
        self.Createnewpanels.setObjectName(u"Createnewpanels")
        ...
        self.MoveDownPanelCommand_NP.setObjectName(u"MoveDownPanelCommand_NP")
        self.MoveDownPanelCommand_NP.setText(u"...")
        ...
        self.MoveUpPanelCommand_NP.setObjectName(u"MoveUpPanelCommand_NP")
        self.MoveUpPanelCommand_NP.setText(u"...")
        ...
        self.RemovePanelCommand_NP.setObjectName(u"RemovePanelCommand_NP")
        self.RemovePanelCommand_NP.setText(u"...")
        ...
        self.AddPanelCommand_NP.setObjectName(u"AddPanelCommand_NP")
        self.AddPanelCommand_NP.setText(u"...")
        ...
        self.AddCustomToolbar_NP.setObjectName(u"AddCustomToolbar_NP")
        sizePolicy7.setHeightForWidth(self.AddCustomToolbar_NP.sizePolicy().hasHeightForWidth())
        ...
        self.CustomToolbarSelector_NP.setObjectName(u"CustomToolbarSelector_NP")
        sizePolicy5.setHeightForWidth(self.CustomToolbarSelector_NP.sizePolicy().hasHeightForWidth())
        self.CustomToolbarSelector_NP.setSizePolicy(sizePolicy5)
        ...
        self.PanelName_NP.setObjectName(u"PanelName_NP")
        sizePolicy5.setHeightForWidth(self.PanelName_NP.sizePolicy().hasHeightForWidth())
        self.PanelName_NP.setSizePolicy(sizePolicy5)
        ...
        self.WorkbenchList_NP.setObjectName(u"WorkbenchList_NP")
        sizePolicy5.setHeightForWidth(self.WorkbenchList_NP.sizePolicy().hasHeightForWidth())
        self.WorkbenchList_NP.setSizePolicy(sizePolicy5)
        ...
        self.RemovePanel_NP.setObjectName(u"RemovePanel_NP")
        sizePolicy6.setHeightForWidth(self.RemovePanel_NP.sizePolicy().hasHeightForWidth())
        self.RemovePanel_NP.setSizePolicy(sizePolicy6)
        ...
        self.WorkbenchList_RD.setObjectName(u"WorkbenchList_RD")
        ...
        self.PanelList_RD.setObjectName(u"PanelList_RD")
        ...
        self.IconOnly_RD = QCheckBox(self.frame2)
        self.IconOnly_RD.setObjectName(u"IconOnly_RD")
        self.IconOnly_RD.setMinimumSize(QSize(0, 34))

        self.gridLayout_13.addWidget(self.IconOnly_RD, 2, 0, 1, 1)

        self.PanelOrder_RD = QListWidget(self.frame2)
        ...
        sizePolicy1.setHeightForWidth(self.PanelOrder_RD.sizePolicy().hasHeightForWidth())
        self.PanelOrder_RD.setSizePolicy(sizePolicy1)
        ...
        self.MoveUpPanel_RD = QToolButton(self.frame2)
        self.MoveUpPanel_RD.setObjectName(u"MoveUpPanel_RD")
        self.MoveUpPanel_RD.setText(u"...")
        self.MoveUpPanel_RD.setArrowType(Qt.ArrowType.UpArrow)

        self.gridLayout_20.addWidget(self.MoveUpPanel_RD, 1, 0, 1, 1)

        self.MoveDownPanel_RD = QToolButton(self.frame2)
        self.MoveDownPanel_RD.setObjectName(u"MoveDownPanel_RD")
        self.MoveDownPanel_RD.setText(u"...")
        ...
        self.gridLayout_15.addLayout(self.gridLayout_19, 1, 0, 1, 1)
        ...
        self.MoveUp_RibbonCommand_RD = QToolButton(self.frame3)
        self.MoveUp_RibbonCommand_RD.setObjectName(u"MoveUp_RibbonCommand_RD")
        self.MoveUp_RibbonCommand_RD.setText(u"...")
        self.MoveUp_RibbonCommand_RD.setArrowType(Qt.ArrowType.UpArrow)

        self.verticalLayout.addWidget(self.MoveUp_RibbonCommand_RD)

        self.MoveDown_RibbonCommand_RD = QToolButton(self.frame3)
        self.MoveDown_RibbonCommand_RD.setObjectName(u"MoveDown_RibbonCommand_RD")
        self.MoveDown_RibbonCommand_RD.setText(u"...")
        ...
        self.CommandTable_RD = QTableWidget(self.frame3)
        ...
        sizePolicy3.setHeightForWidth(self.CommandTable_RD.sizePolicy().hasHeightForWidth())
        self.CommandTable_RD.setSizePolicy(sizePolicy3)
        ...
        self.CommandTable_RD.setStyleSheet(u"border-color: rgb(167, 167rgb(217, 217, 217), 167);")
        self.CommandTable_RD.setFrameShape(QFrame.Shape.StyledPanel)
        self.CommandTable_RD.setFrameShadow(QFrame.Shadow.Sunken)
        ...
        self.AddSeparator_RD = QPushButton(self.frame3)
        ...
        self.RemoveSeparator_RD = QPushButton(self.frame3)
        ...
        self.gridLayout_16.addWidget(self.frame3, 1, 0, 1, 5)
        ...
        self.gridLayout_28.addWidget(self.label_14, 0, 2, 1, 1)

        self.LoadWB = QPushButton(Form)
        self.LoadWB.setObjectName(u"LoadWB")
        sizePolicy6.setHeightForWidth(self.LoadWB.sizePolicy().hasHeightForWidth())
        self.LoadWB.setSizePolicy(sizePolicy6)
        self.LoadWB.setMinimumSize(QSize(10, 10))
        icon = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ViewRefresh))
        self.LoadWB.setIcon(icon)

        self.gridLayout_28.addWidget(self.LoadWB, 0, 0, 2, 1)
        ...
        self.TimeStamp_Reloaded.setFont(font3)

        self.gridLayout_28.addWidget(self.TimeStamp_Reloaded, 1, 2, 1, 1)


        self.gridLayout_6.addLayout(self.gridLayout_28, 2, 0, 1, 11)


        self.gridLayout_53.addLayout(self.gridLayout_6, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.Close_2.setText(QCoreApplication.translate("Form", u"Ok", None))
        self.Cancel_2.setText(QCoreApplication.translate("Form", u"Cancel", None))
        ...
        self.DefaultButtonSize_IS_Workbenches.setItemText(0, QCoreApplication.translate("Form", u"Small", None))
        self.DefaultButtonSize_IS_Workbenches.setItemText(1, QCoreApplication.translate("Form", u"Medium", None))
        self.DefaultButtonSize_IS_Workbenches.setItemText(2, QCoreApplication.translate("Form", u"Large", None))

        self.label_16.setText(QCoreApplication.translate("Form", u"for:", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", u"Set inital button size - Panels", None))
        self.label_24.setText(QCoreApplication.translate("Form", u"Set all buttons to: ", None))
        self.DefaultButtonSize_IS_Panels.setItemText(0, QCoreApplication.translate("Form", u"Small", None))
        self.DefaultButtonSize_IS_Panels.setItemText(1, QCoreApplication.translate("Form", u"Medium", None))
        self.DefaultButtonSize_IS_Panels.setItemText(2, QCoreApplication.translate("Form", u"Large", None))

        self.label_25.setText(QCoreApplication.translate("Form", u"for:", None))
        self.GenerateSetup_IS_Panels.setText(QCoreApplication.translate("Form", u"Generate", None))
        self.ExportBox.setTitle(QCoreApplication.translate("Form", u"Import/Export", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", u"Import workbench layout", None))
        self.ImportWorkbench_IS.setText(QCoreApplication.translate("Form", u"Import workbench", None))
        self.Importlayout_IS.setText(QCoreApplication.translate("Form", u"Import layout", None))
        self.ExportLayout_IS.setText(QCoreApplication.translate("Form", u"Export layout", None))
        self.ImportDropDownButtons_IS.setText(QCoreApplication.translate("Form", u"Import dropdown buttons", None))
        self.ImportCustomPanels_IS.setText(QCoreApplication.translate("Form", u"Import custom panels", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("Form", u"Default custom panel position", None))
...
#if QT_CONFIG(tooltip)
        self.MoveDown_Command_QC.setToolTip(QCoreApplication.translate("Form", u"Move down", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.Remove_Command_QC.setToolTip(QCoreApplication.translate("Form", u"Remove command", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.Add_Command_QC.setToolTip(QCoreApplication.translate("Form", u"Add command", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.RemovePanel_EP.setToolTip(QCoreApplication.translate("Form", u"Include panel", None))
#endif // QT_CONFIG(tooltip)
        self.RemovePanel_EP.setText(QCoreApplication.translate("Form", u"...", None))
#if QT_CONFIG(tooltip)
        self.AddPanel_EP.setToolTip(QCoreApplication.translate("Form", u"Exclude panel", None))
#endif // QT_CONFIG(tooltip)
        self.AddPanel_EP.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        self.SearchBar_EP.setPlaceholderText(QCoreApplication.translate("Form", u"Type to search...", None))
...
#if QT_CONFIG(tooltip)
        self.RemoveWorkbench_IW.setToolTip(QCoreApplication.translate("Form", u"Exclude workbench", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.AddWorkbench_IW.setToolTip(QCoreApplication.translate("Form", u"Include workbench", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.CombineToolbars), QCoreApplication.translate("Form", u"Combine panels", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Form", u"Create dropdown buttons", None))
        self.groupBox.setTitle("")
#if QT_CONFIG(tooltip)
        self.MoveDownPanelCommand_NP.setToolTip(QCoreApplication.translate("Form", u"Move down", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.MoveUpPanelCommand_NP.setToolTip(QCoreApplication.translate("Form", u"Move up", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.RemovePanelCommand_NP.setToolTip(QCoreApplication.translate("Form", u"Remove command", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.AddPanelCommand_NP.setToolTip(QCoreApplication.translate("Form", u"Add command", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.PanelName_NP.setPlaceholderText(QCoreApplication.translate("Form", u"Enter the name of your custom panel...", None))
        self.label_17.setText(QCoreApplication.translate("Form", u"Select workbench:", None))
        self.label_18.setText(QCoreApplication.translate("Form", u"Select custom panel:", None))
        self.RemovePanel_NP.setText(QCoreApplication.translate("Form", u"Remove panel", None))
        self.label_19.setText(QCoreApplication.translate("Form", u"Panel name", None))
        ...
        __sortingEnabled13 = self.PanelOrder_RD.isSortingEnabled()
        self.PanelOrder_RD.setSortingEnabled(False)
        ...
        self.PanelOrder_RD.setSortingEnabled(__sortingEnabled13)

#if QT_CONFIG(tooltip)
        self.MoveUpPanel_RD.setToolTip(QCoreApplication.translate("Form", u"Move up", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.MoveDownPanel_RD.setToolTip(QCoreApplication.translate("Form", u"Move down", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        __sortingEnabled14 = self.CommandTable_RD.isSortingEnabled()
        ...
        self.CommandTable_RD.setSortingEnabled(__sortingEnabled14)
        ...
        self.label_14.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-style:italic;\">Reload workbenches. Be aware, this may take a while!</span></p></body></html>", None))
        self.LoadWB.setText("")
