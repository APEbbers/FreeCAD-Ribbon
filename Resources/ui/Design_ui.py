...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 998, 703))
        ...
        self.DefaultButtonSize_IS_2.addItem("")
        self.DefaultButtonSize_IS_2.addItem("")
        self.DefaultButtonSize_IS_2.setObjectName(u"DefaultButtonSize_IS_2")
        ...
        self.Workbenches_IS.setObjectName(u"Workbenches_IS")
        ...
        self.DefaultButtonSize_IS.addItem("")
        self.DefaultButtonSize_IS.addItem("")
        self.DefaultButtonSize_IS.setObjectName(u"DefaultButtonSize_IS")
        ...
        self.GenerateSetup_IS.setObjectName(u"GenerateSetup_IS")
        ...
        __qlistwidgetitem3 = QListWidgetItem(self.PanelsToExclude_EP)
        ...
        __qlistwidgetitem4 = QListWidgetItem(self.PanelsExcluded_EP)
        ...
        __qlistwidgetitem5 = QListWidgetItem(self.WorkbenchesAvailable_IW)
        ...
        __qlistwidgetitem6 = QListWidgetItem(self.WorkbenchesSelected_IW)
        ...
        __qlistwidgetitem7 = QListWidgetItem(self.PanelAvailable_CP)
        ...
        __qlistwidgetitem8 = QListWidgetItem(self.PanelSelected_CP)
        ...
        __qlistwidgetitem9 = QListWidgetItem(self.CommandsAvailable_NP)
        ...
        __qlistwidgetitem10 = QListWidgetItem(self.NewPanel_NP)
        __qlistwidgetitem10.setCheckState(Qt.Checked);
        self.NewPanel_NP.setObjectName(u"NewPanel_NP")
        self.NewPanel_NP.setSelectionMode(QAbstractItemView.SelectionMode.MultiSelection)
        ...
        __qlistwidgetitem11 = QListWidgetItem(self.CommandsAvailable_DDB)
        ...
        self.MoveDown_PanelCommand_30.setObjectName(u"MoveDown_PanelCommand_30")
        ...
        self.Add_Panel_30.setObjectName(u"Add_Panel_30")
        ...
        self.MoveUp_PanelCommand_30.setObjectName(u"MoveUp_PanelCommand_30")
        ...
        __qlistwidgetitem12 = QListWidgetItem(self.NewControl_DDB)
        __qlistwidgetitem12.setCheckState(Qt.Checked);
        self.NewControl_DDB.setObjectName(u"NewControl_DDB")
        self.NewControl_DDB.setSelectionMode(QAbstractItemView.SelectionMode.MultiSelection)
        ...
        __qlistwidgetitem13 = QListWidgetItem(self.PanelOrder_RD)
    ...
    def retranslateUi(self, Form):
        ...
        self.LoadWB.setText("")
        self.label_14.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-style:italic;\">Reload workbenches. This may take a while.</span></p></body></html>", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", u"Set inital button size - Global panels", None))
        self.label_24.setText(QCoreApplication.translate("Form", u"Set all button to: ", None))
        self.DefaultButtonSize_IS_2.setItemText(0, QCoreApplication.translate("Form", u"Small", None))
        self.DefaultButtonSize_IS_2.setItemText(1, QCoreApplication.translate("Form", u"Medium", None))
        self.DefaultButtonSize_IS_2.setItemText(2, QCoreApplication.translate("Form", u"Large", None))
        ...
        self.label_15.setText(QCoreApplication.translate("Form", u"Set all button to: ", None))
        self.DefaultButtonSize_IS.setItemText(0, QCoreApplication.translate("Form", u"Small", None))
        self.DefaultButtonSize_IS.setItemText(1, QCoreApplication.translate("Form", u"Medium", None))
        self.DefaultButtonSize_IS.setItemText(2, QCoreApplication.translate("Form", u"Large", None))

        self.label_16.setText(QCoreApplication.translate("Form", u"for:", None))
        self.GenerateSetup_IS.setText(QCoreApplication.translate("Form", u"Generate", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.InItialSetup), QCoreApplication.translate("Form", u"Initial setup", None))
        self.MoveUp_Command_QC.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveDown_Command_QC.setText(QCoreApplication.translate("Form", u"...", None))
        self.Remove_Command_QC.setText(QCoreApplication.translate("Form", u"...", None))
        self.Add_Command_QC.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        ___qlistwidgetitem3 = self.CommandsAvailable_QC.item(0)
        ...
        ___qlistwidgetitem4 = self.PanelsToExclude_EP.item(0)
        ...
        ___qlistwidgetitem5 = self.PanelsExcluded_EP.item(0)
        ...
        ___qlistwidgetitem6 = self.WorkbenchesAvailable_IW.item(0)
        ...
        ___qlistwidgetitem7 = self.WorkbenchesSelected_IW.item(0)
        ...
        self.AddWorkbench_IW.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        self.AddCustomPanel_CP.setText(QCoreApplication.translate("Form", u"Add", None))
        ...
        self.RemovePanel_CP.setText(QCoreApplication.translate("Form", u"Remove", None))
        ...
        self.MoveDownPanelCommand_CP.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveUpPanelCommand_CP.setText(QCoreApplication.translate("Form", u"...", None))
        self.AddPanel_CP.setText(QCoreApplication.translate("Form", u"...", None))

        __sortingEnabled7 = self.PanelAvailable_CP.isSortingEnabled()
        self.PanelAvailable_CP.setSortingEnabled(False)
        ___qlistwidgetitem8 = self.PanelAvailable_CP.item(0)
        ...
        self.PanelSelected_CP.setSortingEnabled(False)
        ___qlistwidgetitem9 = self.PanelSelected_CP.item(0)
        ...
        self.AddCustomToolbar_NP.setText(QCoreApplication.translate("Form", u"Add", None))
        ...
        self.RemovePanel_NP.setText(QCoreApplication.translate("Form", u"Remove", None))
        ...
        ___qlistwidgetitem10 = self.CommandsAvailable_NP.item(0)
        ...
        ___qlistwidgetitem11 = self.NewPanel_NP.item(0)
        ...
        self.MoveDownPanelCommand_NP.setText(QCoreApplication.translate("Form", u"...", None))
        self.AddPanelCommand_NP.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveUpPanelCommand_NP.setText(QCoreApplication.translate("Form", u"...", None))
        self.RemovePanelCommand_NP.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        ___qlistwidgetitem12 = self.CommandsAvailable_DDB.item(0)
        ...
        self.MoveDown_PanelCommand_30.setText(QCoreApplication.translate("Form", u"...", None))
        self.Add_Panel_30.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveUp_PanelCommand_30.setText(QCoreApplication.translate("Form", u"...", None))
        self.toolButton_30.setText(QCoreApplication.translate("Form", u"...", None))

        __sortingEnabled12 = self.NewControl_DDB.isSortingEnabled()
        self.NewControl_DDB.setSortingEnabled(False)
        ___qlistwidgetitem13 = self.NewControl_DDB.item(0)
        ...
        self.CreateControl_DDB.setText(QCoreApplication.translate("Form", u"Create dropdown button", None))
        ...
        self.MoveUp_RibbonCommand_RD.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveDown_RibbonCommand_RD.setText(QCoreApplication.translate("Form", u"...", None))
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Form", u"All", None));
        ...
        self.PanelOrder_RD.setSortingEnabled(False)
        ___qlistwidgetitem14 = self.PanelOrder_RD.item(0)
        ___qlistwidgetitem14.setText(QCoreApplication.translate("Form", u"New Item", None));
        self.PanelOrder_RD.setSortingEnabled(__sortingEnabled14)

        self.MoveUpPanel_RD.setText(QCoreApplication.translate("Form", u"...", None))
        self.MoveDownPanel_RD.setText(QCoreApplication.translate("Form", u"...", None))
