...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy1.setHeightForWidth(self.RemovePanel_CP.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.RemovePanel_NP.sizePolicy().hasHeightForWidth())
