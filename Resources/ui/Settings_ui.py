...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 702, 1066))
        ...
        self.ModifierKeyApp_2.addItem("")
        self.ModifierKeyApp_2.addItem("")
        self.ModifierKeyApp_2.setObjectName(u"ModifierKeyApp_2")
        ...
        self.ShortcutTaken_2.setObjectName(u"ShortcutTaken_2")
        ...
        self.ModifierKeyApp.addItem("")
        self.ModifierKeyApp.addItem("")
        self.ModifierKeyApp.setObjectName(u"ModifierKeyApp")
        ...
        self.ShortcutTaken_1.setObjectName(u"ShortcutTaken_1")
        ...
        self.ModifierKeyPref.setObjectName(u"ModifierKeyPref")
        sizePolicy6.setHeightForWidth(self.ModifierKeyPref.sizePolicy().hasHeightForWidth())
        ...
        self.ApplyShortcutPref.setObjectName(u"ApplyShortcutPref")
        ...
        self.ModifierKeyApp_3.addItem("")
        self.ModifierKeyApp_3.addItem("")
        self.ModifierKeyApp_3.setObjectName(u"ModifierKeyApp_3")

        self.gridLayout_36.addWidget(self.ModifierKeyApp_3, 2, 1, 1, 1)

        self.ModifierKeyLayout = QLineEdit(self.groupBox_13)
        self.ModifierKeyLayout.setObjectName(u"ModifierKeyLayout")
        sizePolicy6.setHeightForWidth(self.ModifierKeyLayout.sizePolicy().hasHeightForWidth())
        ...
        self.ApplyShortcutLayout.setObjectName(u"ApplyShortcutLayout")

        self.gridLayout_36.addWidget(self.ApplyShortcutLayout, 2, 4, 1, 1)

        self.ShortcutTaken_3 = QLabel(self.groupBox_13)
        self.ShortcutTaken_3.setObjectName(u"ShortcutTaken_3")
        ...
        self.label_40 = QLabel(Settings)
        self.label_40.setObjectName(u"label_40")

        self.gridLayout_40.addWidget(self.label_40, 1, 1, 1, 1)
        ...
        self.gridLayout_40.addLayout(self.gridLayout_7, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Settings):
        ...
        self.groupBox_13.setTitle(QCoreApplication.translate("Settings", u"Shortcuts", None))
        self.ModifierKeyApp_2.setItemText(0, QCoreApplication.translate("Settings", u"Ctrl", None))
        self.ModifierKeyApp_2.setItemText(1, QCoreApplication.translate("Settings", u"Shift", None))
        self.ModifierKeyApp_2.setItemText(2, QCoreApplication.translate("Settings", u"Alt", None))
        self.ModifierKeyApp_2.setItemText(3, QCoreApplication.translate("Settings", u"Space", None))

        self.label_37.setText(QCoreApplication.translate("Settings", u"Set shortcut for preference menu menu:", None))
        self.ShortcutTaken_2.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p><span style=\" color:#df2a06;\">Shortcut already taken</span></p></body></html>", None))
        self.ModifierKeyApp.setItemText(0, QCoreApplication.translate("Settings", u"Ctrl", None))
        self.ModifierKeyApp.setItemText(1, QCoreApplication.translate("Settings", u"Shift", None))
        self.ModifierKeyApp.setItemText(2, QCoreApplication.translate("Settings", u"Alt", None))
        self.ModifierKeyApp.setItemText(3, QCoreApplication.translate("Settings", u"Space", None))

        self.ShortcutTaken_1.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p><span style=\" color:#df2a06;\">Shortcut already taken</span></p></body></html>", None))
        self.label_31.setText(QCoreApplication.translate("Settings", u"+", None))
        self.label_38.setText(QCoreApplication.translate("Settings", u"+", None))
        self.label_8.setText(QCoreApplication.translate("Settings", u"Set shortcut for application menu:", None))
        self.ModifierKeyPref.setPlaceholderText(QCoreApplication.translate("Settings", u"Enter a key...", None))
        self.ApplyShortcutApp.setText(QCoreApplication.translate("Settings", u"Apply", None))
        self.AppShortCut.setPlaceholderText(QCoreApplication.translate("Settings", u"Enter a key...", None))
        self.ApplyShortcutPref.setText(QCoreApplication.translate("Settings", u"Apply", None))
        self.label_39.setText(QCoreApplication.translate("Settings", u"Set shortcut for the layout menu:", None))
        self.ModifierKeyApp_3.setItemText(0, QCoreApplication.translate("Settings", u"Ctrl", None))
        self.ModifierKeyApp_3.setItemText(1, QCoreApplication.translate("Settings", u"Shift", None))
        self.ModifierKeyApp_3.setItemText(2, QCoreApplication.translate("Settings", u"Alt", None))
        self.ModifierKeyApp_3.setItemText(3, QCoreApplication.translate("Settings", u"Space", None))

        self.ModifierKeyLayout.setPlaceholderText(QCoreApplication.translate("Settings", u"Enter a key...", None))
        self.ApplyShortcutLayout.setText(QCoreApplication.translate("Settings", u"Apply", None))
        self.ShortcutTaken_3.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p><span style=\" color:#df2a06;\">Shortcut already taken</span></p></body></html>", None))
        ...
        self.groupBox_12.setTitle(QCoreApplication.translate("Settings", u"Overlay preferences", None))
...
"Uncheck this when there are issues with the overlay function and the FreeCAD Ribbon.", None))
        ...
        self.label_40.setText(QCoreApplication.translate("Settings", u"+", None))
