...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
...
#endif // QT_CONFIG(shortcut)
        self.DebugMode.setText(QCoreApplication.translate("Form", u"Debug mode", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-style:italic;\">Debug mode enables extra reports in the report view for debugging purposes.</span></p></body></html>", None))
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"Ribbon settings", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", u"Show text", None))
        self.ShowText_Small.setText(QCoreApplication.translate("Form", u"Small buttons", None))
        self.ShowText_Medium.setText(QCoreApplication.translate("Form", u"Medium buttons", None))
        self.ShowText_Large.setText(QCoreApplication.translate("Form", u"Large buttons", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("Form", u"Button size", None))
        self.label_11.setText(QCoreApplication.translate("Form", u"Size of medium buttons:", None))
        self.label_10.setText(QCoreApplication.translate("Form", u"Size of small buttons:", None))
        self.groupBox_5.setTitle(QCoreApplication.translate("Form", u"Panels", None))
        self.label.setText(QCoreApplication.translate("Form", u"No. of columns per panel", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-style:italic;\">Set to '0'  to disable the maximum of columns</span></p></body></html>", None))
        ...
        self.groupBox1.setTitle(QCoreApplication.translate("Form", u"Backup settings", None))
