...
class Ui_Settings(object):
    ...
    def retranslateUi(self, Settings):
        ...
        self.label_29.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p><span style=\" font-style:italic;\">(Can be modified afterwards)</span></p></body></html>", None))
