...
################################################################################
## Form generated from reading UI file 'SettingsfhGGfK.ui'
##
...
class Ui_Settings(object):
    ...
    def retranslateUi(self, Settings):
        ...
        self.groupBox_13.setTitle(QCoreApplication.translate("Settings", "Shortcuts", None))
        self.ModifierKeyApp_2.setItemText(0, QCoreApplication.translate("Settings", "Ctrl", None))
        self.ModifierKeyApp_2.setItemText(1, QCoreApplication.translate("Settings", "Shift", None))
        self.ModifierKeyApp_2.setItemText(2, QCoreApplication.translate("Settings", "Alt", None))
        self.ModifierKeyApp_2.setItemText(3, QCoreApplication.translate("Settings", "Space", None))

        self.label_37.setText(QCoreApplication.translate("Settings", "Set shortcut for preference menu menu:", None))
        ...
        self.ModifierKeyPref.setPlaceholderText(QCoreApplication.translate("Settings", "Enter a key...", None))
        self.ApplyShortcutApp.setText(QCoreApplication.translate("Settings", "Apply", None))
        self.AppShortCut.setPlaceholderText(QCoreApplication.translate("Settings", "Enter a key...", None))
        self.ApplyShortcutPref.setText(QCoreApplication.translate("Settings", "Apply", None))
        self.label_39.setText(QCoreApplication.translate("Settings", "Set shortcut for the layout menu:", None))
        self.ModifierKeyApp_3.setItemText(0, QCoreApplication.translate("Settings", "Ctrl", None))
        self.ModifierKeyApp_3.setItemText(1, QCoreApplication.translate("Settings", "Shift", None))
        self.ModifierKeyApp_3.setItemText(2, QCoreApplication.translate("Settings", "Alt", None))
        self.ModifierKeyApp_3.setItemText(3, QCoreApplication.translate("Settings", "Space", None))

        self.ModifierKeyLayout.setPlaceholderText(QCoreApplication.translate("Settings", "Enter a key...", None))
        self.ApplyShortcutLayout.setText(QCoreApplication.translate("Settings", "Apply", None))
        ...
        self.label_40.setText(QCoreApplication.translate("Settings", "+", None))
