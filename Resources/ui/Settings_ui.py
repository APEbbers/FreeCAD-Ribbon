...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.gridLayout_6 = QGridLayout(Settings)
        ...
        self.gridLayout_6.addWidget(self.DockedButtonFrame, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 681, 1278))
        ...
        self.HideTitleBarFC.setFont(font)
        ...
        self.MaxPanelColumn.setObjectName(u"MaxPanelColumn")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.MaxPanelColumn.sizePolicy().hasHeightForWidth())
        self.MaxPanelColumn.setSizePolicy(sizePolicy4)
        ...
        self.gridLayout_3.addWidget(self.groupBox_5, 6, 0, 1, 1)
        ...
        self.SizeButtonBox.setMinimumSize(QSize(5, 0))
        self.SizeButtonBox.setAutoFillBackground(False)
        self.SizeButtonBox.setStyleSheet(u"border-right: 2px solid red;\n"
...
"                                              border-bottom-right-radius: 15px;")
        ...
        self.gridLayout.addWidget(self.SizeButtonBox, 0, 2, 5, 1)
        ...
        sizePolicy4.setHeightForWidth(self.IconSize_rightToolbarButton.sizePolicy().hasHeightForWidth())
        self.IconSize_rightToolbarButton.setSizePolicy(sizePolicy4)
        self.IconSize_rightToolbarButton.setMinimumSize(QSize(60, 20))
        self.IconSize_rightToolbarButton.setBaseSize(QSize(0, 0))
        self.IconSize_rightToolbarButton.setFont(font1)
        ...
        sizePolicy4.setHeightForWidth(self.IconSize_Medium.sizePolicy().hasHeightForWidth())
        ...
        self.gridLayout.addWidget(self.LinkIconSizes, 0, 3, 5, 1)
        ...
        sizePolicy4.setHeightForWidth(self.IconSize_QuickAccessButton.sizePolicy().hasHeightForWidth())
        self.IconSize_QuickAccessButton.setSizePolicy(sizePolicy4)
        self.IconSize_QuickAccessButton.setMinimumSize(QSize(60, 20))
        self.IconSize_QuickAccessButton.setBaseSize(QSize(0, 0))
        self.IconSize_QuickAccessButton.setFont(font1)
        ...
        sizePolicy5.setHeightForWidth(self.IconSize_ApplicationButton.sizePolicy().hasHeightForWidth())
        self.IconSize_ApplicationButton.setSizePolicy(sizePolicy5)
        self.IconSize_ApplicationButton.setMinimumSize(QSize(60, 20))
        self.IconSize_ApplicationButton.setBaseSize(QSize(0, 0))
        self.IconSize_ApplicationButton.setFont(font1)
        ...
        sizePolicy4.setHeightForWidth(self.TabbarHeight.sizePolicy().hasHeightForWidth())
        self.TabbarHeight.setSizePolicy(sizePolicy4)
        self.TabbarHeight.setMinimumSize(QSize(60, 20))
        self.TabbarHeight.setBaseSize(QSize(0, 0))
        self.TabbarHeight.setFont(font1)
        ...
        self.TextSize_Menus.setObjectName(u"TextSize_Menus")
        sizePolicy5.setHeightForWidth(self.TextSize_Menus.sizePolicy().hasHeightForWidth())
        self.TextSize_Menus.setSizePolicy(sizePolicy5)
        ...
        self.TextSize_Menus.setFont(font)
        ...
        self.TextSize_Menus.setProperty(u"showGroupSeparator", False)
        ...
        self.TextSize_Buttons.setObjectName(u"TextSize_Buttons")
        self.TextSize_Buttons.setFont(font)
        ...
        self.TextSize_Tabs.setObjectName(u"TextSize_Tabs")
        self.TextSize_Tabs.setFont(font)
        ...
        self.TextSize_Panels.setObjectName(u"TextSize_Panels")
        self.TextSize_Panels.setFont(font)
        ...
        self.gridLayout_3.addWidget(self.groupBox_14, 4, 0, 1, 1)
        ...
        self.ShowText_Medium.setObjectName(u"ShowText_Medium")
        sizePolicy4.setHeightForWidth(self.ShowText_Medium.sizePolicy().hasHeightForWidth())
        self.ShowText_Medium.setSizePolicy(sizePolicy4)
        self.ShowText_Medium.setMinimumSize(QSize(100, 0))
        self.ShowText_Medium.setFont(font)

        self.gridLayout_26.addWidget(self.ShowText_Medium, 1, 0, 1, 1)

        self.EnableWrap_Large = QCheckBox(self.groupBox_3)
        self.EnableWrap_Large.setObjectName(u"EnableWrap_Large")
        ...
        self.ShowText_Large.setObjectName(u"ShowText_Large")
        sizePolicy4.setHeightForWidth(self.ShowText_Large.sizePolicy().hasHeightForWidth())
        self.ShowText_Large.setSizePolicy(sizePolicy4)
        self.ShowText_Large.setMinimumSize(QSize(100, 0))
        self.ShowText_Large.setFont(font)
        ...
        self.ShowText_Small.setObjectName(u"ShowText_Small")
        sizePolicy4.setHeightForWidth(self.ShowText_Small.sizePolicy().hasHeightForWidth())
        self.ShowText_Small.setSizePolicy(sizePolicy4)
        self.ShowText_Small.setMinimumSize(QSize(100, 0))
        self.ShowText_Small.setFont(font)
        ...
        self.EnableWrap_Medium.setObjectName(u"EnableWrap_Medium")
        ...
        sizePolicy7.setHeightForWidth(self.StyleSheetLocation.sizePolicy().hasHeightForWidth())
        self.StyleSheetLocation.setSizePolicy(sizePolicy7)
        ...
        self.gridLayout_44.addWidget(self.groupBox, 1, 0, 1, 1)

        self.groupBox1 = QGroupBox(self.scrollAreaWidgetContents_4)
        ...
        self.EnableBackup.setFont(font)
        ...
        sizePolicy8.setHeightForWidth(self.groupBox_Backup.sizePolicy().hasHeightForWidth())
        self.groupBox_Backup.setSizePolicy(sizePolicy8)
        self.groupBox_Backup.setMinimumSize(QSize(0, 50))
        self.groupBox_Backup.setFont(font)
        ...
        sizePolicy7.setHeightForWidth(self.BackUpLocation.sizePolicy().hasHeightForWidth())
        self.BackUpLocation.setSizePolicy(sizePolicy7)
        ...
        self.gridLayout_44.addWidget(self.groupBox1, 0, 0, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_44.addItem(self.verticalSpacer_4, 2, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 681, 646))
        ...
        self.EnableEnterEvent.setObjectName(u"EnableEnterEvent")
        ...
        self.ScrollSpeed_Ribbon.setObjectName(u"ScrollSpeed_Ribbon")
        ...
        self.ScrollSpeed_TabBar.setObjectName(u"ScrollSpeed_TabBar")
        ...
        self.gridLayout_43.addWidget(self.groupBox_6, 0, 0, 1, 1)
        ...
        self.ScrollClicks_TabBar.setObjectName(u"ScrollClicks_TabBar")
        ...
        self.ScrollClicks_TabBar.setFont(font)
        ...
        self.ScrollClicks_TabBar.setProperty(u"showGroupSeparator", False)
        ...
        self.ScrollClicks_Ribbon.setObjectName(u"ScrollClicks_Ribbon")
        ...
        self.ScrollClicks_Ribbon.setFont(font)
        ...
        self.gridLayout_43.addWidget(self.groupBox_7, 1, 0, 1, 1)
        ...
        sizePolicy10.setHeightForWidth(self.groupBox_8.sizePolicy().hasHeightForWidth())
        self.groupBox_8.setSizePolicy(sizePolicy10)
        self.gridLayout_21 = QGridLayout(self.groupBox_8)
        self.gridLayout_21.setObjectName(u"gridLayout_21")
        self.CustomColors = QCheckBox(self.groupBox_8)
        self.CustomColors.setObjectName(u"CustomColors")

        self.gridLayout_21.addWidget(self.CustomColors, 0, 0, 1, 1)

        self.BorderTransparant = QCheckBox(self.groupBox_8)
        self.BorderTransparant.setObjectName(u"BorderTransparant")
        ...
        self.gridLayout_20.addWidget(self.Color_Background_Hover, 1, 1, 1, 1)
        ...
        self.gridLayout_20.addWidget(self.label_31, 5, 0, 1, 1)

        self.Color_Font = Gui.ColorButton(self.ColorS)
        self.Color_Font.setObjectName(u"Color_Font")

        self.gridLayout_20.addWidget(self.Color_Font, 5, 1, 1, 1)
        ...
        self.gridLayout_20.addWidget(self.Color_Background_TitleBar, 4, 1, 1, 1)
        ...
        self.gridLayout_20.addWidget(self.Color_Background_Tabs, 3, 1, 1, 1)
        ...
        self.gridLayout_35.addItem(self.horizontalSpacer_5, 0, 1, 1, 1)
        ...
        self.CustomIcons.setObjectName(u"CustomIcons")
        ...
        self.gridLayout_32 = QGridLayout(self.tab_3)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 681, 695))
        ...
        self.label_40 = QLabel(self.AdvancedGroup)
        self.label_40.setObjectName(u"label_40")

        self.gridLayout_41.addWidget(self.label_40, 2, 0, 1, 1)

        self.horizontalSpacer_13 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_41.addItem(self.horizontalSpacer_13, 1, 3, 1, 1)

        self.ButtonSpacing = QSpinBox(self.AdvancedGroup)
        self.ButtonSpacing.setObjectName(u"ButtonSpacing")
        self.ButtonSpacing.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.ButtonSpacing.setMaximum(100)
        self.ButtonSpacing.setValue(6)

        self.gridLayout_41.addWidget(self.ButtonSpacing, 5, 1, 1, 1)

        self.label_39 = QLabel(self.AdvancedGroup)
        self.label_39.setObjectName(u"label_39")

        self.gridLayout_41.addWidget(self.label_39, 4, 0, 1, 1)

        self.ButtonSizeFactor = QDoubleSpinBox(self.AdvancedGroup)
        self.ButtonSizeFactor.setObjectName(u"ButtonSizeFactor")
        self.ButtonSizeFactor.setFont(font)
        self.ButtonSizeFactor.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.ButtonSizeFactor.setDecimals(1)
        ...
        self.gridLayout_41.addWidget(self.ButtonSizeFactor, 3, 1, 1, 1)

        self.ResetAdvancedSettings = QPushButton(self.AdvancedGroup)
        self.ResetAdvancedSettings.setObjectName(u"ResetAdvancedSettings")

        self.gridLayout_41.addWidget(self.ResetAdvancedSettings, 6, 0, 1, 2)

        self.label_38 = QLabel(self.AdvancedGroup)
        self.label_38.setObjectName(u"label_38")

        self.gridLayout_41.addWidget(self.label_38, 3, 0, 1, 1)

        self.label_37 = QLabel(self.AdvancedGroup)
        self.label_37.setObjectName(u"label_37")
        self.label_37.setMinimumSize(QSize(191, 0))

        self.gridLayout_41.addWidget(self.label_37, 1, 0, 1, 1)
        ...
        self.RibbonHeightOffset.setFont(font)
        self.RibbonHeightOffset.setFocusPolicy(Qt.FocusPolicy.WheelFocus)
        self.RibbonHeightOffset.setFrame(True)
        ...
        self.label_42 = QLabel(self.AdvancedGroup)
        self.label_42.setObjectName(u"label_42")

        self.gridLayout_41.addWidget(self.label_42, 5, 0, 1, 1)

        self.MinimumRibbonHeight = QSpinBox(self.AdvancedGroup)
        self.MinimumRibbonHeight.setObjectName(u"MinimumRibbonHeight")
        self.MinimumRibbonHeight.setFont(font)
        ...
        self.PanelHeightOffset = QSpinBox(self.AdvancedGroup)
        self.PanelHeightOffset.setObjectName(u"PanelHeightOffset")
        self.PanelHeightOffset.setFont(font)
        ...
        self.gridLayout_41.addWidget(self.PanelHeightOffset, 2, 1, 1, 1)

        self.label_44 = QLabel(self.AdvancedGroup)
        ...
        self.gridLayout_28.addWidget(self.groupBox_15, 2, 0, 1, 1)
        ...
        self.gridLayout_28.addWidget(self.groupBox_11, 0, 0, 1, 1)

        self.OverlaySettings = QGroupBox(self.scrollAreaWidgetContents_2)
        self.OverlaySettings.setObjectName(u"OverlaySettings")
        sizePolicy3.setHeightForWidth(self.OverlaySettings.sizePolicy().hasHeightForWidth())
        self.OverlaySettings.setSizePolicy(sizePolicy3)
        ...
        sizePolicy12.setHeightForWidth(self.label_45.sizePolicy().hasHeightForWidth())
        self.label_45.setSizePolicy(sizePolicy12)
        ...
        self.gridLayout_28.addWidget(self.OverlaySettings, 1, 0, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_28.addItem(self.verticalSpacer_3, 3, 0, 1, 1)
        ...
        self.DebugMode = QCheckBox(self.tab_3)
        self.DebugMode.setObjectName(u"DebugMode")
        sizePolicy8.setHeightForWidth(self.DebugMode.sizePolicy().hasHeightForWidth())
        self.DebugMode.setSizePolicy(sizePolicy8)
        ...
        self.gridLayout_32.addLayout(self.verticalLayout_2, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Settings):
        Settings.setWindowTitle(QCoreApplication.translate("Settings", u"Preferences", None))
        ...
        self.groupBox_14.setTitle(QCoreApplication.translate("Settings", u"Text size", None))
        self.label_32.setText(QCoreApplication.translate("Settings", u"Text size of menus", None))
        self.label_34.setText(QCoreApplication.translate("Settings", u"Text size of tabs", None))
        ...
        self.ShowText_Medium.setText(QCoreApplication.translate("Settings", u"Medium buttons", None))
        self.EnableWrap_Large.setText(QCoreApplication.translate("Settings", u"Enable text wrap", None))
        self.ShowText_Large.setText(QCoreApplication.translate("Settings", u"Large buttons", None))
        self.ShowText_Small.setText(QCoreApplication.translate("Settings", u"Small buttons", None))
        self.EnableWrap_Medium.setText(QCoreApplication.translate("Settings", u"Enable text wrap", None))
        ...
        self.groupBox_6.setTitle(QCoreApplication.translate("Settings", u"Mouse settings", None))
        self.EnableEnterEvent.setText(QCoreApplication.translate("Settings", u"Show ribbon on hover. ", None))
        self.label_12.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p>Scroll speed for ribbon:</p></body></html>", None))
        self.label_13.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p>Scroll speed for tab bar:</p></body></html>", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("Settings", u"Scroll buttons", None))
        self.label_14.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p>Scroll steps per click for ribbon:</p></body></html>", None))
        self.label_15.setText(QCoreApplication.translate("Settings", u"<html><head/><body><p>Scroll steps per click for tab bar:</p></body></html>", None))
        self.label_41.setText(QCoreApplication.translate("Settings", u"Use the \"Tools->Customize...\" menu to set shortcuts.", None))
        ...
        self.PreferedViewPanel.setItemText(2, QCoreApplication.translate("Settings", u"Views - Ribbon", None))
