...
class RibbonGallery(QFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._upButton.setIcon(QIcon(DataFile("icons/up.svg")))
        ...
        self._downButton.setIcon(QIcon(DataFile("icons/down.svg")))
        ...
        self._moreButton.setIcon(QIcon(DataFile("icons/more.svg")))
