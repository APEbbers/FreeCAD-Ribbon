{
    "language": "English",
    "ignoredToolbars": ["Clipboard", "Edit", "File", "Help", "Macro", "View", "Workbench"],
    "iconOnlyToolbars": ["Individual views", "Structure"],
    "quickAccessCommands": [
        "Std_New",
        "Std_Open",
        "Std_Save",
    ...
    "ignoredWorkbenches": ["Inspection", "Material", "OpenSCAD", "Points", "Reverse Engineering", "Test Framework"],
    "customToolbars": {
        "TechDrawWorkbench": {
        ...
        "BIMWorkbench": {
            "toolbars": {
                ...
                "2D modification tools": {
                    "order": ["Offset", "2D Offset", "Trimex", "Join", "Split", "Scale", "Stretch", "Draft to sketch"],
        ...
        "AssemblyWorkbench": {
            "toolbars": {
                ...
                "Assembly": {
                    ...
                    "commands": {
                        "Assembly_CreateAssembly": {"size": "large", "text": "Create Assembly", "icon": "Geoassembly"}
                    },
                },
                "Assembly Joints": {
                    "order": [
                        ...
                        "Create Parallel Joint",
                        "Create Perpendicular Joint",
                        "Create Angle Joint",
                    ...
                    "commands": {
                        "Assembly_ToggleGrounded": {
                            "size": "large",
                            "text": "Toggle grounded",
                            "icon": "Assembly_ToggleGrounded",
                        }
                    },
                },
                "Individual views": {
        ...
        "DraftWorkbench": {
            "toolbars": {
                ...
                "Draft creation tools": {
                    ...
                    "commands": {"Draft_Line": {"size": "large", "text": "Line", "icon": "Draft_Line"}},
                },
                "Draft annotation tools": {
                    "order": ["Text", "Dimension", "Label", "Annotation styles"],
                    "commands": {"Draft_Text": {"size": "large", "text": "Text", "icon": "Draft_Text"}},
                },
                "Draft modification tools": {
                    "order": [
                        "Move",
                ...
                "Draft utility tools": {
                    "order": [
                        ...
                        "Toggle normal/wireframe display",
        ...
        "MaterialWorkbench": {
            "toolbars": {
                "order": [
                    ...
                    "Help",
                    "Materials",
                    "BoM Toolbar - MaterialWorkbench",
                ],
                "Materials": {
                    "order": ["Edit"],
                    "commands": {"Materials_Edit": {"size": "large", "text": "Edit...", "icon": "Materials_Edit"}},
                },
            }
        },
        "MeshWorkbench": {
            "toolbars": {
                "order": [
                    ...
                    "Mesh segmentation",
                    "Mesh analyze",
                    "BoM Toolbar - MeshWorkbench",
                ],
                "Mesh tools": {
                    "order": ["Import mesh", "Export mesh", "Create mesh from shape", "Regular solid"],
                    "commands": {"Mesh_Import": {"size": "large", "text": "Import mesh...", "icon": "Mesh_Import"}},
                },
                "Mesh modify": {
                    "order": [
                        "Harmonize normals",
                    ...
                    "commands": {
                        "Mesh_HarmonizeNormals": {
                            "size": "large",
                            "text": "Harmonize normals",
                            "icon": "Mesh_HarmonizeNormals",
                        }
                    },
                },
                "Mesh boolean": {
                    "order": ["Union", "Intersection", "Difference"],
                    "commands": {"Mesh_Union": {"size": "large", "text": "Union", "icon": "Mesh_Union"}},
                },
                "Mesh cutting": {
                    "order": [
                        "Cut mesh",
                    ...
                    "commands": {"Mesh_PolyCut": {"size": "large", "text": "Cut mesh", "icon": "Mesh_PolyCut"}},
                },
                "Mesh segmentation": {
                    "order": [
                        "Merge",
                        ...
                        "Create mesh segments from best-fit surfaces",
                    ],
                    "commands": {"Mesh_Merge": {"size": "large", "text": "Merge", "icon": "Mesh_Merge"}},
                },
                "Mesh analyze": {
                    "order": [
                    ...
                    "commands": {
                        "Mesh_Evaluation": {
                            "size": "large",
                            "text": "Evaluate and repair mesh...",
                            "icon": "Mesh_Evaluation",
                        }
                    },
                },
            }
        ...
        "OpenSCADWorkbench": {
            "toolbars": {
                "order": [
                    ...
                    "BoM Toolbar - OpenSCADWorkbench",
                ],
                "OpenSCAD Tools": {
                    "order": [
                        "Replace Object",
                        "Remove Objects and their Children",
                        "Explode Group",
                ...
                "Frequently-used Part WB tools": {
                    ...
                    "commands": {
                        "Part_CheckGeometry": {"size": "large", "text": "Check Geometry", "icon": "Part_CheckGeometry"}
                    },
                },
            }
        },
                ...
                "Points tools": {
                    ...
                    "commands": {
                        "Points_Import": {
                            "size": "large",
                            "text": "Import points...",
                            "icon": "Points_Import_Point_cloud",
                        }
                    },
                },
            }
        ...
        "ReverseEngineeringWorkbench": {
            "toolbars": {
                "order": [
                    ...
                    "Help",
                    "Reverse Engineering",
                    "BoM Toolbar - ReverseEngineeringWorkbench",
                ],
                "Reverse Engineering": {
                    "order": ["Approximate B-spline surface"],
                    "commands": {
                        "Reen_ApproxSurface": {
                            "size": "large",
                            "text": "Approximate B-spline surface...",
                            "icon": "actions/FitSurface",
                        }
                    },
                },
            }
        ...
        "RobotWorkbench": {
            "toolbars": {
                ...
                "Robot": {
                    ...
                    "commands": {
                        "Robot_Create": {"size": "large", "text": "Place robot...", "icon": "Robot_CreateRobot"}
                    },
                },
            }
        },
        "SurfaceWorkbench": {
            "toolbars": {
                ...
                "Surface": {
                    ...
                    "commands": {"Surface_Filling": {"size": "large", "text": "Filling...", "icon": "Surface_Filling"}},
                },
            }
        },
        "TestWorkbench": {
            "toolbars": {
                ...
                "TestTools": {
                    "order": ["Self-test", "Test all", "Test Document", "Test base"],
                    "commands": {"Test_Test": {"size": "large", "text": "Self-test...", "icon": ""}},
                },
            }
        },
    },
