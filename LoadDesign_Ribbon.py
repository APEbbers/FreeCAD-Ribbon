...
class LoadDialog(Design_ui.Ui_Form):
    ...
    def addWorkbenches(self):
        ...
        self.form.WorkbenchList.setInsertPolicy(QComboBox.InsertPolicy.InsertAlphabetically)
        self.form.WorkbenchList_2.setInsertPolicy(QComboBox.InsertPolicy.InsertAlphabetically)
