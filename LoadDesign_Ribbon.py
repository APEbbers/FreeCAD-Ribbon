        ...
        for Toolbar in self.StringList_Toolbars:
            ...
            if (
                ...
                if (
                    ...
                    or self.form.ListCategory_EP.currentData(Qt.ItemDataRole.UserRole)
                    == "All"
                ):
                    IsInlist = False
    ...
    def FilterCommands_SearchBar(
        ...
        for ToolbarCommand in self.List_Commands:
            ...
            if f"{CommandName}" not in ShadowList:
                if (
                    SearchBar.text() != ""
                    and MenuNameTranslated.lower().startswith(SearchBar.text().lower())
                ) or SearchBar.text() == "":
                    IsInlist = False
                    for i in range(ListWidget.count()):
                        CommandItem = ListWidget.item(i)
                    ...
                    if (
                        ...
                        if IsInlist is False:
                            ...
                            for item in self.List_CommandIcons:
                                ...
                                if (
                                    CommandName_icon.endswith("_ddb")
                                    and "dropdownButtons" in self.Dict_DropDownButtons
                                ):
                                    for (
                                        DropDownCommand,
